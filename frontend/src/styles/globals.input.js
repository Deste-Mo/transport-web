...
export const globalInputVariants = {
    ...
    variant : {
        ...
        fill : "text-black-80  border-black-10 bg-input-l dark:bg-input-d  placeholder:text-black-60 outline-none focus:ring-primary-100 focus:ring-2  dark:placeholder:text-white-60  dark:text-white-80 dark:border-white-60 ",
        default : "outline",
    },
