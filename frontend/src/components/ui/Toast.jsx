...
const Toast = ({
  ...
  return (
    <div
      className={` flex items-center gap-6 bg-secondary-l dark:bg-secondary-d dark:backdrop-blur-sm border border-black-0  py-3 px-6 rounded-xl justify-between w-fit dark:text-white-100 ${
        !error
