...
const Messages = () => {
    ...
    const { messages, userToChat, getUnreadMessageCount, getUserMessages, handleShowConversation } = useApp()
            ...
            <div
                ...
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex items-center gap-2 cursor-pointer">
                        ...
                        <p className={"text-black-100 dark:text-white-100 text-lead cursor-pointer hover:underline"} onClick={() => goToUserProfile(userToChat.id)}>{userToChat.fullName}<span
