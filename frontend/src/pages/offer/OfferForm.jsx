...
import {Button, FileInput, SelectInput, TextArea, TextInput} from "../../styles/components.js";
import {globalInputVariants} from "../../styles/globals.input.js";
import {getTodayDate, formatDateForInput} from "../../utils/helpers.js";
import {useNavigate, useParams} from "react-router-dom";

const OfferForm = ({ offers = null }) => {
    const {id} = useParams();
