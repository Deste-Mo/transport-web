...
const RegisterPass = ({ inputs, setinputs, setAuth, getInformation }) => {
    ...
    console.log({ firstname, lastname, usercin, companynumber, phone, adress, email, bio, profileimage, accountid, password, confirmPassword });
    ...
    const onSubmitForm = async e => {
        ...
        try {
            const body = { firstname, lastname, usercin, companynumber, phone, adress, email, bio, profileimage, accountid, password, confirmPassword };
    ...
    return (
        <section className="w-fullscreen">
            ...
            <form className="mt-[10px] flex justify-center items-center" onSubmit={onSubmitForm}>
                <div>
                    ...
                    <div className="mb-5">
                        ...
                        <TextInput onChange={e => handleChange(e)} className="w-[275px]" type="password" placeholder="" name="password" id="password" />
                    </div>
                    <div className="mb-5">
                        <label htmlFor="confirmPassword" className="text-small-1 text-gray-100">Confirmez</label>
                        <TextInput onChange={e => handleChange(e)} className="w-[275px]" type="password" placeholder="" name="confirmPassword" id="password" />
                    </div>
