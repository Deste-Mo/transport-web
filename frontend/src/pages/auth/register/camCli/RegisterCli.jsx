                    ...
                    <div className="flex justify-arround items-center">
                        ...
                        <div>
                            ...
                            <div className="mb-5 mt-3">
                                <label htmlFor="cin" className="text-small-1 text-gray-100">CIN</label>
                                <TextInput className="w-[275px]" type="text" placeholder="" name="cin" id="cin" />
                            </div>
                            <div className="mb-5">
                                <label htmlFor="firstname" className="text-small-1 text-gray-100">Nom</label>
                                <TextInput className="w-[275px]" type="text" placeholder="" name="firstname" id="firstname" />
                            </div>
                            <div className="mb-5">
                                <label htmlFor="lastname" className="text-small-1 text-gray-100">Prenom</label>
                                <TextInput className="w-[275px]" type="text" placeholder="" name="lastname" id="lastname" />
                            </div>
                            <div className="mb-5">
                        ...
                        <div>
                            ...
                            <div className="mb-5">
                                <label htmlFor="bio" className="text-small-1 text-gray-100 block">Description</label>
