...
export default function Profile() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full overflow-x-hidden overflow-y-scroll  scrollbar-none h-[86vh] rounded-xl">
      ...
      <div className="flex flex-col gap-6">
        <SubHeader icon="bi bi-person-fill" name={`Follower${(friendFollowerCount > 1) ? 's' : ''}`} rightContent={<p className="text-black-100 dark:text-white-100">{friendFollowerCount}</p>} />
