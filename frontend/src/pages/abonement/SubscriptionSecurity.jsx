                    ...
                    <tbody>
                      <tr className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4 text-gray-700">
                          {location.id === "Basique" && "1 mois"}
                          {location.id === "Standard" && "2 mois"}
                          {location.id === "Premium" && "1 an"}
                        </td>
                      </tr>
                      <tr className="border-b border-gray-200 hover:bg-gray-50">
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4 text-gray-700">
                          {location.id === "Basique" && "50 000 Ar"}
                          {location.id === "Standard" && "100 000 Ar"}
                          {location.id === "Premium" && "200 000 Ar"}
                        </td>
                      </tr>
                      <tr className="border-b border-gray-200 hover:bg-gray-50">
